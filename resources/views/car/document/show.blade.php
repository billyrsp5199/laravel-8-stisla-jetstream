            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <span>
                           <h6>{{$document->carID->model}} {{__("Plate Number")}}: {{$document->carID->vehicle}}</h6> 
                        </span>
                            ...
                            <table class="display" id="dataTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="{{URL::to($document->attached_path)}}" class="btn btn-primary">{{__('View')}}</a></td>
                                        <td>{{$document->remark}}</td>
                                        <td>
                                            <a class='btn btn-primary' href="{{route('documentcar.edit',$document->id)}}">
                                                {{__("Edit")}}
                                            </a>
                                        </td>
                                    </tr>
