                            ...
                            <div class="card-body">
                                <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="form-group">
                                                <div class="form-row mb-2 justify-content-center">
                                                    <div class="picture-container">
                                                        <div class="picture">
                                                            <img src="{{ URL::to('/') }}/{{$data->profile_path}}" class="picture-src" id="wizardPicturePreview" title="">
                                                        </div>
                                    ...
                                    <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                        <form action="{{route('driver.update',$data->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <fieldset>
                                                    ...
                                                    <div class="col-md-6">
                                                       <label class="form-control-label" for="phone">{{__("Phone Number")}}
                                                        ...
                                                        <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                                            <input type="text" name="phone" id="phone" maxlength="10" class="form-control form-control-alternative{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="{{ __('20xxxxxxxx') }}" value="{{ $data->phone }}" required autofocus>
                                                            @if ($errors->has('phone'))
                                                            <span class="invalid-feedback" role="alert" style="display: block">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('driver_name_la') ? ' has-danger' : '' }}">
                                                            <input type="text" name="driver_name_la" id="driver_name_la" class="form-control form-control-alternative{{ $errors->has('driver_name_la') ? ' is-invalid' : '' }}" placeholder="{{ __('Driver Name') }} ({{__('Lao')}})" value="{{ $data->fullname_la }}" required autofocus>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('driver_name_en') ? ' has-danger' : '' }}">
                                                            <input type="text" name="driver_name_en" id="driver_name_en" class="form-control form-control-alternative{{ $errors->has('driver_name_en') ? ' is-invalid' : '' }}" placeholder="{{ __('Driver Name') }} ({{__('English')}})" value="{{ $data->fullname_eng }}" required autofocus>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group input-group-alternative mb-3">
                                                            <input type="text" name="license_issue_date" id="license_issue_date" data-toggle="datepicker-license-issue" class="form-control form-control-alternative{{ $errors->has('license_issue_date') ? ' is-invalid' : '' }}" placeholder="{{ __('License Issue Date') }}" value="{{date('d/m/Y', strtotime($data->license_issue_date )) }}" required autofocus>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group input-group-alternative mb-3">
                                                            <input type="text" name="license_exp_date" id="license_exp_date"  data-toggle="datepicker-license-exp" class="form-control form-control-alternative{{ $errors->has('license_exp_date') ? ' is-invalid' : '' }}" placeholder="{{ __('License Expire Date') }}" value="{{date('d/m/Y', strtotime($data->license_expire_date )) }}" required autofocus>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('attached') ? ' has-danger' : '' }}">
                                                            <div class="custom-file">
                                                                <input type="file" name="attached" class="custom-file-input" id="attached" accept="application/pdf">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        {{ $errors->has('division_id') ? '  is-invalid has-danger' : '' }}" id="division_id" name="division_id" required data-style="btn-outline-secondary" data-live-search="false">
                                                                <option value="" disabled>{{__("Select Division")}}</option>
                                                                @foreach($dv as $row)
                                                                <option {{($data->division_id == $row->id) ? "selected":""}} value="{{$row->id}}">
...
<script>
    $(document).ready(function() {
        ...
        $("#attached").change(function() {
            ...
            if (typeof(attached.files) !== "undefined") {
                let size = parseFloat(attached.files[0].size / (1024 * 1024)).toFixed(2);
                if (size > 2) {
                ...
                $("#nameFileAttached").text("browser ນີ້ບໍ່ຮ້ອງຮັບ");
            }
