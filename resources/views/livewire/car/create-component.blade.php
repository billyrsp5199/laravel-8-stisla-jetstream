                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('model') ? ' has-danger' : '' }}">
                                                            <input type="text" name="model" id="input-model" class="form-control form-control-alternative{{ $errors->has('model') ? ' is-invalid' : '' }}" placeholder="{{ __('Model') }}" value="{{ old('model') }}" required autofocus>
                                                            @if ($errors->has('model'))
                                                            <span class="invalid-feedback" role="alert" style="display: block">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group input-group-alternative mb-3">
                                                            <input type="text" name="serial_number" id="input-serial_number" class="form-control form-control-alternative{{ $errors->has('serial_number') ? ' is-invalid' : '' }}" placeholder="{{ __('Serial Number') }}" value="{{ old('serial_number') }}" required autofocus>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('engine_number') ? ' has-danger' : '' }}">
                                                            <input type="text" name="engine_number" id="engine_number" class="form-control form-control-alternative{{ $errors->has('engine_number') ? ' is-invalid' : '' }}" placeholder="{{ __('Engine Number') }}" value="{{ old('engine_number') }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('power_cc') ? ' has-danger' : '' }}">
                                                            <input type="text" name="power_cc" id="power_cc" class="form-control form-control-alternative{{ $errors->has('power_cc') ? ' is-invalid' : '' }}" placeholder="{{ __('Power CC') }}" value="{{ old('power_cc') }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('date_start_usage') ? ' is-invalid has-danger' : '' }}">
                                                            <div class="input-group">
                                                                ...
                                                                <input placeholder="{{__('Select Date')}}" type="text" class="form-control" value="{{ old('date_start_usage') }}" name="date_start_usage" id="date_start_usage" data-toggle="datepicker-date">
