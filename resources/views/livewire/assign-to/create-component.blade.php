                            ...
                            <div class="card-body">
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                        <form action="{{route('assignto.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                            @csrf
                                            @method('POST')
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('assign_to_la') ? ' has-danger' : '' }}">
                                                            <input type="text" name="assign_to_la" id="assign_to_la" class="form-control form-control-alternative{{ $errors->has('assign_to_la') ? ' is-invalid' : '' }}" placeholder="{{ __('Assign To') }} ({{__('Lao')}})" value="{{ old('assign_to_la') }}" required autofocus>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('assign_to_en') ? ' has-danger' : '' }}">
                                                            <input type="text" name="assign_to_en" id="assign_to_en" class="form-control form-control-alternative{{ $errors->has('assign_to_en') ? ' is-invalid' : '' }}" placeholder="{{ __('Assign To') }} ({{__('English')}})" value="{{ old('assign_to_en') }}" required autofocus>
