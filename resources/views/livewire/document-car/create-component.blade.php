                            ...
                            <div class="card-body">
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                        <form action="{{route('documentcar.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                            @csrf
                                            @method('POST')
                                            <fieldset>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('insurance_exp') ? ' is-invalid has-danger' : '' }}">
                                                            <div class="input-group">
                                                                ...
                                                                <input placeholder="{{__('Select Date')}}" type="text" class="form-control" value="{{ old('insurance_exp') }}" name="insurance_exp" id="insurance_exp" data-toggle="datepicker-date">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('tax_road_date') ? ' is-invalid has-danger' : '' }}">
                                                            <div class="input-group">
                                                                ...
                                                                <input placeholder="{{__('Select Date')}}" type="text" class="form-control" value="{{ old('tax_road_date') }}" name="tax_road_date" id="tax_road_date" data-toggle="datepicker-date">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group{{ $errors->has('attached') ? ' has-danger' : '' }}">
                                                            <div class="custom-file">
                                                                ...
                                                                <spanclass="text-danger" id="nameFileAttached"></spanclass=>
                                                            </div>
